...
\paragraph{ }
For source code compiling the GCC version 8.2.1 toolchain is used through the Ninja build system. And these are configured with CMake to which provides a cross-platform build tool configuring interface. Also, it provides an opportunity for developers to use their own preferred IDE, Integrated Development Environment, therefore boost their productivity.
