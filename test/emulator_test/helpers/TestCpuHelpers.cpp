...
std::string parseCurrentStateLog(const Emulator::Memory::Memory& memory, const Emulator::Cpu::Registers& registers)
{
    ...
    switch (memory.getFrom(registers.getProgramCounter()))
    {
        ...
        case 0x61: sstream << "0x61 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        case 0x71: sstream << "0x71 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        ...
        case 0x21: sstream << "0x21 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        case 0x31: sstream << "0x31 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        ...
        case 0xA1: sstream << "0xA1 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        case 0xB1: sstream << "0xB1 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        ...
        case 0xE1: sstream << "0xE1 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        case 0xF1: sstream << "0xF1 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        ...
        case 0x81: sstream << "0x81 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        case 0x91: sstream << "0x91 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        ...
        case 0xC1: sstream << "0xC1 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        case 0xD1: sstream << "0xD1 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        ...
        case 0x41: sstream << "0x41 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        case 0x51: sstream << "0x51 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        ...
        case 0x01: sstream << "0x01 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
        case 0x11: sstream << "0x11 " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +1) << " " << "0x" << setfill('0') << setw(2) << hex << (int)memory.getFrom(registers.getProgramCounter() +2); break;
